$(document).ready(function(){
     var gotopobj=document.getElementById("goTopBtn");
        ...
        window.onscroll=function(){getScrollTop()>60?gotopobj.style.display="":gotopobj.style.display="none";}
        gotopobj.onclick=function(){
        ...
        obj.click(function(){   
            ...
            if(sideobj.css("display") != 'none'){
                ...
                sideobj.css("display","");  
                mainobj.addClass("disp").css("width","72%").css("float","left").css("margin","1em 0 0");  
            }
                }
        })
}); 